...
namespace APIVerve
{
    public class TitleCapitalizationAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/titlecapitalization";
        ...
        public TitleCapitalizationAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TitleCapitalizationAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TitleCapitalizationQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(TitleCapitalizationQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(TitleCapitalizationQueryOptions options)
        {
