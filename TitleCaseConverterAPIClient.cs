...
namespace APIVerve
{
    public class TitleCaseConverterAPIClient
    {
        ...
        public TitleCaseConverterAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TitleCaseConverterAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TitleCaseConverterQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(TitleCaseConverterQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(TitleCaseConverterQueryOptions options)
        {
